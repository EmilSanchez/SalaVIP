...
while True:
    ...
    if tarjeta > 0:
        ...
        print("")
        print(WHITE+"1. Piedra, Papel o Tijera         Valor ----> $25000 Pesos","Con Posibilidad de Ganar 45000 Pesos")
        print("2. De compras con Emil            Valor ----> $18000 Pesos","Con Posibilidad de Ganar 26000 Pesos")
        print("3. Gana Dinero Lanzando el Dardo  Valor ----> $45000 Pesos","Con Posibilidad de Ganar entre 45000 hasta 85000 Pesos")
        print("")
        print("4. Salir")
        print("")
